...
def controller(model, data):
    global debug_robot, initial_data, initial_state, current_state, actions_done, todo, debug_actions, episodes, action, stale_count, stale_limit, rewards, score, reset_delay, next_state
